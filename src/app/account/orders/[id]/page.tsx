  ...
  const labels = useMemo(
    () => ({
      en: {
        ...
        cancelled: "This order was cancelled by sucre et sel. Contact us if you have questions.",
      ...
      es: {
        ...
        cancelled: "Este pedido fue cancelado por sucre et sel. Contáctenos si tiene preguntas.",
