    ...
    <section className="min-h-[calc(100vh-4rem)] bg-neutral-50">
      <div className="container-page flex flex-col items-center py-10">
        ...
        <div className="mt-10 grid w-full max-w-md grid-cols-2 gap-3 sm:max-w-2xl sm:grid-cols-4">
          {[
            { Icon: Award, label: t("login.trustedQuality") },
            { Icon: Truck, label: t("login.fastDelivery") },
            { Icon: Headphones, label: t("login.localSupport") },
        ...
        <p className="mt-6 text-center text-xs text-neutral-400">
          © {new Date().getFullYear()} My Recette · {t("common.all")} {t("common.rights")} {t("common.reserved")}.
        </p>
      </div>
    </section>
  );
